...
public class MyGenerator_plus {
        ...
        public static void main(String[] args) throws InterruptedException {
            ...
            String val = rb.getString("tableName");
            if (val == "all" ||val == "" ||val == null){
                strategy.setInclude(new String[]{"t_admin","t_audit","t_auth_bank","t_auth_mobile","t_identity","t_image","t_info","t_item","t_project","t_register"});
            }
