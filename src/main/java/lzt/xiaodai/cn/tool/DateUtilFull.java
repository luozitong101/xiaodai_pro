...
public class DateUtilFull {
        ...
        public static boolean validateIsDate(String strTime) {
            ...
            if (date != null) {
                System.out.println("生成的日期:"+ DateUtilFull.parseDateToStr(date, DateUtilFull.DATE_TIME_FORMAT_YYYY_MM_DD_HH_MI_SS, "--null--"));
                return true;
            }
            return false;
        }
         ...
         */
        public static long[] getDistanceTime(String str1, String str2) throws Exception{
 ...
 /*
    public static void main(String [] args){
        try {
            DateUtilFull dateUtil = new DateUtilFull();
            System.out.println();
